...
\begin{center}
\begin{tabbing}
\texttt{Archive:~} \= \= \url{http://www.econ2.jhu.edu/people/ccarroll/SolvingMicroDSOPs.pdf} \kill \\  % This line establishes the locations of the tabs, but is not printed because of the \kill directive
...
\end{eqnarray}
\end{verbatimwrite}
\input{./Equations/valfuncFOCRtilde.tex}
...
\end{eqnarray}
\end{verbatimwrite}
\input{./Equations/naivePowell.tex}
